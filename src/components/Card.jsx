...
import { BsCalendarEventFill, BsChevronRight } from "react-icons/bs"
                      ...
                      <div className="flex flex-row justify-between ">
                        ...
                        <div className="bg-[#66c69c] flex items-center justify-center w-[20px] cursor-pointer">
                          <BsChevronRight
                            onClick={() => {
                              router.push(
                                `/DetailsPage?address=${fullAddress}&imageUrl=${imageUrl}&bedrooms=${bedrooms}&bathrooms=${bathrooms}&sqft=${sqft}&yearBuilt=${yearBuilt}`
                              )
                            }}
